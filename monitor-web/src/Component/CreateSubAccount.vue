...
<template>
  <div style="padding: 15px 20px;height: 100%">
    <div style="display: flex;flex-direction: column;height: 100%">
      <div>
        <div class="title" >
          <i class="fa-solid fa-user-plus"></i> 添加新的子管理账户
        </div>
        <div class="desc" style="margin: 10px 15px">子管理账户只能管理被分配到的服务器。</div>
        ...
        <el-form label-position="top" :rules="rules" :model="form"
          ...
          <el-form-item label="用户名" prop="username">
            <el-input type="text" v-model="form.username"
                      :prefix-icon="User" placeholder="子管理账户用户名" maxlength="16"/>
          </el-form-item>
          <el-form-item label="电子邮件" prop="email">
            <el-input type="email" v-model="form.email"
                      :prefix-icon="Message" placeholder="子管理账户子邮件" maxlength="16"/>
          </el-form-item>
          <el-form-item label="密码" prop="password">
            <el-input type="password" v-model="form.password"
                      :prefix-icon="Lock" placeholder="子管理账户密码" maxlength="16"/>
          </el-form-item>
        </el-form>
        <el-divider style="margin: 10px 0"/>
        <div class="desc">请在下方选择允许子管理账户访问的服务器列表。</div>
      </div>
