...
public class AccountServiceImpl extends ServiceImpl<AccountMapper, Account> implements AccountService {
     ...
     */
    public String sendEmailVerifyCode(String type, String email, String address){
        synchronized (address.intern()) {
            ...
            if(type == "reset")
            {
                ...
                stringRedisTemplate.opsForValue()
                        .set(Const.MODIFY_EMAIL_DATA + email, String.valueOf(code), 3, TimeUnit.MINUTES);
            }
            else {
                stringRedisTemplate.opsForValue()
                        .set(Const.LOGIN_EMAIL_DATA + email, String.valueOf(code), 3, TimeUnit.MINUTES);
            }
    ...
    public String resetEmailAccountPassword(EmailResetVO info) {
        String verify = emailVerifyCodetConfirm(new EmailVerifyCodeConfirmVO(info.getEmail(), info.getCode()));
     ...
     */
    @Override
    public String emailVerifyCodetConfirm(EmailVerifyCodeConfirmVO info) {
        String email = info.getEmail();
        String code = this.getEmailLoginVerifyCode(email);
     ...
     */
    @Override
    public String getEmailLoginVerifyCode(String email){
        String key = Const.LOGIN_EMAIL_DATA + email;
    ...
    public String modifyEmail(int id, ModifyEmailVO vo) {
        String code = getEmailLoginVerifyCode(vo.getEmail());
        if (code == null) return "请先获取验证码";
